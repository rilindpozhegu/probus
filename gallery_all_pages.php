        ...
        <div class="row">
            <div class="swiper-container">
                <ul class="swiper-wrapper" id="lightgallery">
                    <li class="swiper-slide" data-src="img/gallery/360crane.jpg" style="background: url(img/gallery/360crane.jpg)">
                    ...
                    <li class="swiper-slide" data-src="img/gallery/DSC05254.jpg" style="background: url(img/gallery/DSC05254.jpg)">
                        <a href="" class="parent__link">
                            <div class="mask__overlay">
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </div>
                    ...
                    <li class="swiper-slide" data-src="img/gallery/DSC05273.jpg" style="background: url(img/gallery/DSC05273.jpg)">
                        <a href="" class="parent__link">
                            <div class="mask__overlay">
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </div>
                    ...
                    <li class="col-xs-6 col-sm-4 col-md-3 small_padding-lr" data-src="img/gallery/Installation is completed for Turbine & Generator is completed in Tuba Site  (4).jpg">
                        <a href="" class="parent__link">
                          <div class="mask__overlay">
                            ...
                            <img class="img-responsive" src="img/gallery/Installation is completed for Turbine & Generator is completed in Tuba Site  (4).jpg">
                        </a>
                    </li>
                </ul>    
            </div>
