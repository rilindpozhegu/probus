        ...
        <div class="row">
            ...
            <div class="col-md-4 wow fadeInUp" data-wow-duration="0.4s" data-wow-delay=".3s">
                <div class="activities_small_cards">
                    <h4>Engineering</h4>
                    <p>Engineering services including basic design and detailed engineering is delivered through our Abu Dhabi Branch, plus our Engineering office in India.</p>
            ...
            <div class="col-md-4 wow fadeInUp" data-wow-duration="0.4s" data-wow-delay=".2s">
                <div class="activities_small_cards">
                    <h4>Procurement</h4>
                    <p>Probus function with ISO9001 approved processes and procedures to maintain the highest standard in quality and efficiency</p>
                    <a href="#"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                </div>
            </div>
            <div class="col-md-4 wow fadeInUp" data-wow-duration="0.4s" data-wow-delay=".3s">
                <div class="activities_small_cards">
                    <h4>Construction</h4>
                    <p>Probus carries out construction projects up until commissioning and handover. By providing in- country management teams and direct labour, Probus ensures delivery on cost and schedule while maintaining the highest quality.</p>
                    <a href="#"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
