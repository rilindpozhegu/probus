    ...
    <div class="container">
        <div class="row">
            ...
            <div class="clearfix"></div>
                <h1 class="wow fadeInUp" data-wow-duration="0.4s" data-wow-delay=".3s" style="color: #253A7F; font-size: 35px;">EPC</h1>
            <div class="col-md-4 wow fadeInUp" data-tilt data-wow-duration="0.4s" data-wow-delay=".3s">
            ...
            <div class="col-md-4 wow fadeInUp"  data-tilt data-wow-duration="0.4s" data-wow-delay=".2s">
                <div class="activities_small_cards">
