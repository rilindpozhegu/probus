...
<!-- First Section On Quality and HSSE -->

<section class="fisrt_quality_section">
    <div class="container-fluid">
        <div class="row">
                <div class="col-md-6 no_padding">
                    <img src="img/quality/Yearly Statistics.jpg">
                </div>
            ...
            <div class="col-md-6 no_padding">
                <img src="img/quality/Managing Hazards.jpg">
            </div>
            <div class="col-md-6 quality_text_panel">
            ...
            <div class="col-md-6 desktop-d-n">
                <img src="img/quality/Improvements.jpg">
            </div>
            <div class="col-md-6 quality_text_panel">
...
<section class="benefits_using_probus_s probus_quality_slider">
    <div class="container">
        <div class="row">
            <div class="responsive_portfolio">
                ...
                <div class="staff_panel_sm">
                    <div class="staff_small_p_text ">
                        ...
                        <p class="wow fadeInUp" data-wow-duration="0.4s" data-wow-delay=".3s">Probus is a company that is ISO 9001 and 14001 certified<br>Probus guarantees a high level of quality due to the way that workflow is processed. Throughout each of the steps of engineering, procurement, and construction, we maintain this standard by running checks, evaluations and reviews. We log any lessons we learn throughout each project and combine them with client feedback in order to not only maintain our standards of excellence throughout a project, but to raise them for each subsequent one.</p>
                        <a href="Policies.pdf"><button class="blue_button_all wow fadeInUp" data-wow-duration="0.4s" data-wow-delay=".4s">Policies</button></a>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal-boddy">
