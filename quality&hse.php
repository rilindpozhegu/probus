    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="col-md-6 quality_text_panel">
                    ...
                    <button class="blue_button_all wow fadeInUp" data-wow-duration="0.4s" data-wow-delay=".4s"  data-toggle="modal" data-target="#myModal">View PDF</button>
                </div>
...
<section class="home_input_style white_contact_form_style">
